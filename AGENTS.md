...
This repository contains the Better Content Forge mod **Burnt Grass Compatibility**.

- Canonical mod ID: `burnt_grass_compat`
- Canonical artifact: `burnt-grass-compat-<version>.jar`
